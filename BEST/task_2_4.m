...
% fixed RMS value
desiredRms = 0.1;
x_const = x_const * desiredRms/rms(x_const);
x_unif = x_unif * desiredRms/rms(x_unif);
x_schr = x_schr * desiredRms/rms(x_schr);
...
% store .dat
save("x_const.mat", "x_const");
save("x_unif.mat", "x_unif");
save("x_schr.mat", "x_schr");
