...
%x_rand_noise = N*real(ifft(X_rand_noise)); % Generate the signal
x_rand_noise = randn(N,1); % Periodic noise signal
[b, a] = cheby1(5,2,K/(fs/2),'low');
x_rand_noise = filter(b,a,x_rand_noise);
...
x_rand_noise = x_rand_noise*RMS_sig/rms(x_rand_noise); % Normalize the signal

save("x_schr_2_10_periodic.mat", "x_schr");
save("x_const_2_10_periodic.mat", "x_const");
save("x_unif_2_10_periodic.mat", "x_unif");
save("x_rand_2_10_periodic.mat", "x_rand");
save("x_rand_noise_2_10_periodic.mat", "x_rand_noise");
